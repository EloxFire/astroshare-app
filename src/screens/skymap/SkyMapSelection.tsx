    ...
    <View style={globalStyles.body}>
      ...
      <ScrollView>
        ...
        <View style={satelliteTrackerHomeStyles.buttons}>
          ...
          <ToolButton disabled={starCatalogLoading} text={i18n.t('skymap.buttons.planetarium.title')} subtitle={i18n.t('skymap.buttons.planetarium.subtitle')} image={require('../../../assets/images/tools/skymap.png')} onPress={() => navigation.navigate(routes.planetarium.path)} />
          <ToolButton disabled isPremium text={i18n.t('skymap.buttons.constellations.title')} subtitle={i18n.t('skymap.buttons.constellations.subtitle')} image={require('../../../assets/images/tools/skymap.png')} onPress={() => navigation.navigate(routes.planetarium.path)} />
        </View>

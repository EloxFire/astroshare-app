      ...
      <ScrollView style={{ borderTopWidth: 0.5, borderTopColor: app_colors.white_twenty }}>
        ...
        <View style={homeStyles.toolsSuggestions}>
          ...
          <View style={homeStyles.toolsSuggestions.buttons}>
            <ToolButton disabled={!hasInternetConnection || !currentUserLocation} navigation={navigation} targetScreen={routes.weather.path} text={i18n.t('home.buttons.weather.title')} subtitle={i18n.t('home.buttons.weather.subtitle')} icon={require('../../assets/icons/FiCloudLightning.png')} image={require('../../assets/images/tools/weather.png')} />
            <ToolButton isPremium={!isProUser(currentUser)} disabled={!hasInternetConnection || !isProUser(currentUser)} navigation={navigation} targetScreen={routes.lightpollution.home.path} text={i18n.t('home.buttons.lightpollution.title')} subtitle={i18n.t('home.buttons.lightpollution.subtitle')} image={require('../../assets/images/tools/lightpollutionmap.png')} icon={require('../../assets/icons/FiSun.png')} />
            <ToolButton disabled={!hasInternetConnection || !currentUserLocation} navigation={navigation} targetScreen={routes.moonPhases.path} text={i18n.t('home.buttons.moon_phases.title')} subtitle={i18n.t('home.buttons.moon_phases.subtitle')} icon={require('../../assets/icons/FiMoon.png')} image={require('../../assets/images/tools/moonphases.png')} />
            <ToolButton disabled={!hasInternetConnection || !currentUserLocation} navigation={navigation} targetScreen={routes.transits.home.path} text={i18n.t('home.buttons.transits.title')} subtitle={i18n.t('home.buttons.transits.subtitle')} icon={require('../../assets/icons/FiTransit.png')} image={require('../../assets/images/tools/solareclipse.png')} />
            <ToolButton disabled={!hasInternetConnection || !currentUserLocation || dsoCatalogLoading || starsCatalogLoading} navigation={navigation} targetScreen={routes.observationPlanner.path} text={i18n.t('home.buttons.observationPlanner.title')} subtitle={i18n.t('home.buttons.observationPlanner.subtitle')} icon={require('../../assets/icons/FiCalendar.png')} image={require('../../assets/images/tools/observationplanner.png')} />
            <ToolButton navigation={navigation} targetScreen={routes.checklistManager.home.path} text={i18n.t('home.buttons.checklist_manager.title')} subtitle={i18n.t('home.buttons.checklist_manager.subtitle')} icon={require('../../assets/icons/FiFileText.png')} image={require('../../assets/images/tools/checklists.png')} />
          </View>
        </View>
        <View style={homeStyles.toolsSuggestions}>
          ...
          <View style={homeStyles.toolsSuggestions.buttons}>
            <ToolButton disabled={!currentUserLocation} navigation={navigation} targetScreen={routes.scopeAlignment.path} text={i18n.t('home.buttons.scope_alignment.title')} subtitle={i18n.t('home.buttons.scope_alignment.subtitle')} icon={require('../../assets/icons/FiCompass.png')} image={require('../../assets/images/tools/polaralign.png')} />
            <ToolButton disabled={!hasInternetConnection || !currentUserLocation} navigation={navigation} targetScreen={routes.clock.home.path} text={i18n.t('home.buttons.clock.title')} subtitle={i18n.t('home.buttons.clock.subtitle')} icon={require('../../assets/icons/FiClock.png')} image={require('../../assets/images/tools/timezones.png')} />

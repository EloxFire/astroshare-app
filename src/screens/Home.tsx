      ...
      <ScrollView style={{ borderTopWidth: 1, borderTopColor: app_colors.white_twenty }}>
        ...
        <View style={homeStyles.nasaTools}>
          ...
          <View style={homeStyles.nasaTools.buttons}>
            ...
            <ToolButton disabled={!hasInternetConnection} navigation={navigation} targetScreen={routes.launchesScreen.path} text={i18n.t('home.buttons.launches_screen.title')} subtitle={i18n.t('home.buttons.launches_screen.subtitle')} image={require('../../assets/images/tools/launches.png')} />
          </View>
        </View>
      </ScrollView>
    </View>

    ...
    <View style={globalStyles.body}>
      ...
      <ScrollView>
        <View style={settingsStyles.content}>
          ...
          <BigButton icon={require('../../assets/icons/FiTranslation.png')} text="Langue" subtitle="// Changez la langue de l'application" targetScreen="LanguageSelection" navigation={navigation} />
          <BigButton icon={require('../../assets/icons/FiShield.png')} text="Permissions" subtitle="// Gérez les accès de l'application" onPress={() => Linking.openSettings()} />
          <BigButton icon={require('../../assets/icons/FiInfo.png')} text="À propos" subtitle="// Version, contact, légal" navigation={navigation} targetScreen={routes.about.path} />
        </View>
      </ScrollView>
    </View>
  );

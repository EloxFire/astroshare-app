    ...
    <View style={globalStyles.body}>
      ...
      <ScrollView>
        <View style={settingsStyles.content}>
          ...
          <BigButton icon={require('../../assets/icons/FiViewPoint.png')} text="Lieux d'observation" subtitle="// Configurez vos lieux d'observation favoris" navigation={navigation} targetScreen={routes.favoritesViewPoints} />
          ...
          <BigButton icon={require('../../assets/icons/FiInfo.png')} text="À propos" subtitle="// Version, contact, legal" navigation={navigation} targetScreen={routes.about} />
        </View>
      </ScrollView>
    </View>
  );

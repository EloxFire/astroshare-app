    ...
    <View style={globalStyles.body}>
      ...
      <ScrollView>
        <View style={settingsStyles.content}>
          ...
          <BigButton icon={require('../../assets/icons/FiLifeBuoy.png')} text={i18n.t('settings.buttons.tutorial.title')} subtitle={i18n.t('settings.buttons.tutorial.subtitle')} targetScreen="Tutorial" navigation={navigation} />

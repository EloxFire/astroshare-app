  ...
  return (
    <View style={globalStyles.body}>
      ...
      <View style={settingsStyles.content}>
        ...
        <BigButton icon={require('../../assets/icons/FiEye.png')} text="Données cellulaires" subtitle="// Utiliser internet même hors wifi" hasCheckbox isChecked={isCellularDataEnabled} onPress={() => handleCellularData()} />

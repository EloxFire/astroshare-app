export const apodTranslations = {
  ...
  errors: {
    ...
    fetchError: "Error while retrieving APOD data. Please try again later.",
    unknownError: "An unknown error occurred while retrieving APOD data. Please try again later.",
  },
};

export const resourcesHomeTranslations = {
  title: "Ressources",
  subtitle: "Enrichissez votre expérience astronomique.",
  no_categories: "Aucune catégorie de ressources disponible pour le moment.",
